...
> Last updated: 2026-05-06 (v4.2.3B staged — Module 3 Data Polish + Thin-Bucket Completion).
...
- **Service worker `VERSION`**: `'v4.2.3B'` (bumped in v4.2.3B for cache invalidation after Module 3 data polish 62→85).
- **App backup `appVersion`**: `'4.2.3B'`.
