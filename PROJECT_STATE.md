...
> Last updated: 2026-05-06 (v4.2.2F staged)
...
- **Last committed + pushed**: `v4.2.2E` — Final Postflop Text Integrity Repair + R29 Hardening (`3cc3704`).
...
- **Service worker `VERSION`**: `'v4.2.2F'` (bumped in v4.2.2F for cache invalidation of new Training Command Center).
- **App backup `appVersion`**: `'4.2.2F'`.
