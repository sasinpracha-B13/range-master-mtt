...
> Last updated: 2026-05-06 (v4.2.2G staged)
...
- **Service worker `VERSION`**: `'v4.2.2G'` (bumped in v4.2.2G for cache invalidation of TCC polish).
- **App backup `appVersion`**: `'4.2.2G'`.
