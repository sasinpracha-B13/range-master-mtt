...
- **Service worker `VERSION`**: `'v4.2.3'` (bumped in v4.2.3 for cache invalidation after Module 3 production migration).
- **App backup `appVersion`**: `'4.2.3'`.
