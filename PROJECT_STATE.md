...
> Last updated: 2026-05-06 (v4.2.3A staged — Module 3 Data Expansion).
...
- **Service worker `VERSION`**: `'v4.2.3A'` (bumped in v4.2.3A for cache invalidation after Module 3 data expansion 24→62).
- **App backup `appVersion`**: `'4.2.3A'`.
