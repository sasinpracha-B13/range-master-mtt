...
> Last updated: 2026-05-06 (v4.2.2D staged)
...
- **Service worker `VERSION`**: `'v4.2.2D'` (bumped in v4.2.2D for cache invalidation of card-notation-repaired data + new R29 guard).
- **App backup `appVersion`**: `'4.2.2D'`.
