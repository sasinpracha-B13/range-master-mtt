...
- **Service worker `VERSION`**: `'v4.1.9'` (unchanged in v4.2.0 — planning sprint does not bump).
- **App backup `appVersion`**: `'4.1.9'` (unchanged in v4.2.0 — planning sprint does not bump).
