...
> Last updated: 2026-05-06 (v4.2.4 committed + pushed `81d54c5`; reconciliation in flight).
...
- **Service worker `VERSION`**: `'v4.2.4'` (bumped in v4.2.4 for cache invalidation after Module 3 Limited Beta runtime wire).
- **App backup `appVersion`**: `'4.2.4'`.
