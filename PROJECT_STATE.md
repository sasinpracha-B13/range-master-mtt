...
> Last updated: 2026-05-06 (v4.2.2E staged)
...
- **Service worker `VERSION`**: `'v4.2.2E'` (bumped in v4.2.2E for cache invalidation of final-text-integrity repaired data + R29 hardening).
- **App backup `appVersion`**: `'4.2.2E'`.
