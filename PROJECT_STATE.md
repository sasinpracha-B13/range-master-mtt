...
- **Service worker `VERSION`**: `'v4.2.2C'` (bumped in v4.2.2C for cache invalidation of cleaned data + patched runtime).
- **App backup `appVersion`**: `'4.2.2C'`.
